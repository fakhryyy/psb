...
<body class="d-flex flex-column min-vh-100">
        ...
        <nav class="navbar navbar-expand-lg fixed-top navbar-dark py-0 shadow bg-custom">
            <div class="container-fluid">
                ...
                <a class="navbar-brand " href="{{ url('/') }}">
                    <img src="{{ asset('assets/logoBU.png') }}" width="50" height="50"
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ml-auto">
                            <li class="nav-item nav-atas <?= Request::segment(1) == 'daftar' ? 'active' : '' ?>">
                                <strong><a class="nav-link <?= Request::segment(1) == 'daftar' ? 'text-white' : '' ?>"
                                        href="{{ url('/daftar') }}">Daftar</a></strong>
                            </li>
                            <li class="nav-item nav-atas <?= Request::segment(1) == 'data-santri' ? 'active' : '' ?>">
                                <strong><a class="nav-link <?= Request::segment(1) == 'data-santri' ? 'text-white' : '' ?>"
                                        href="{{ url('/data-santri') }}">Data Santri</a></strong>
                            </li>
                            @if (Auth::user()->id == '1')
                                <li class="nav-item nav-atas <?= Request::segment(1) == 'pengaturan' ? 'active' : '' ?>">
                                    <strong><a
                                            class="nav-link > <?= Request::segment(1) == 'pengaturan' ? 'text-white' : '' ?>"
                                            href="{{ url('/pengaturan') }}">Pengaturan</a></strong>
                                </li>
                            @endif
    ...
    <footer class="bg-light mt-auto">
        <div class="container py-3 text-center" style="font-size: 10pt;">
            <strong>Sekretariat : Pondok Pesantren Bustanul Ulum Mlokorejo | Jln. KH Abdullah Yaqien No. 1-5 Mlokorejo
            </strong>
        </div>
    </footer>
